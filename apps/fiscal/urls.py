...
urlpatterns = [
    ...
    path('api/buscar-transportadoras/', views.api_buscar_transportadoras, name='api_buscar_transportadoras'),
    path('api/buscar-produtos-fiscal/', views.api_buscar_produtos_fiscal, name='api_buscar_produtos_fiscal'),
